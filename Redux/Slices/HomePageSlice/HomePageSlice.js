...
export const fetchCars = createAsyncThunk('homePage/fetch', async (page, { getState }) => {
    ...
    const bodyTypeUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=body_type`
    const extColUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=exterior_color`
    const intColUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=interior_color`
    const transUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=transmission`
    const dTrainUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=drivetrain`
    const fuelTypeUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=fuel_type`
    const featureUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=features`
    const modelUrl = `https://autodigg.com/ad-api/cars/list?body_type=${state.bodyTypesCars}&model=${state.modelType}&year_from=${state.years[0]}&year_to=${state.years[1]}&price_from=${state.rate[0]}&price_to=${state.rate[1]}&make=${state.makeCars}&car_type=Certified+pre-owned,${state.newUsed.length > 1 ? state.newUsed.join(",") : "Used+car,New+car"}&page=${state.page}&radius=${state.radius}${state.exteriorColorType.length>0 ? `&exterior_color=${state.exteriorColorType}`: ""}${state.interiorColorType.length>0 ? `&interior_color=${state.interiorColorType}`: ""}${state.transmissionType.length>0 ? `&transmission=${state.transmissionType}`: ""}${state.driveTrainType.length>0 ? `&drivetrain=${state.driveTrainType}`: ""}${state.FuelType.length>0 ? `&fuel_type=${state.FuelType}`: ""}&return=model`
