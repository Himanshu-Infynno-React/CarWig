...
function SideFilterBar({ props, setAllCars, setAllCount }) {
  ...
  function handleBodyTypeCars(e) {
    ...
    e.target.checked
      ...
      : arr2.splice(arr2.indexOf(e.target.value), 1);
    ...
    <>
      <section className="max-h-[50000px] bg-white">
        <div className="w-[312px] flex flex-col h-full p-[16px] bg-white">
          <h1 className="font-[700] text-[16px] text-[#28293D] leading-[24px]">
            Filter by
          </h1>
          <div
            className="w-[30px] h-[2px] rounded-[10px] mt-[8px] mb-[24px]"
            style={{
              background:
          ...
          <div className="flex flex-col gap-[14px]">
            <div>
              <h4 className="font-[600] text-[12px] text-[#8F90A6] leading-[16px]">
                CAR TYPE
              </h4>
            </div>
            <div className="flex  items-center gap-[26px]">
              <div className="flex justify-center items-center gap-[10px]">
                <input
                  ...
                  className="w-[20px] h-[20px] rounded-[4px] border-[2px] border-[#8F90A6] accent-black "
                  type="checkbox"
                  name="New"
                  id=""
                />
                <label
                  className="font-[500] text-[14px] text-[#28293D] leading-[20px]"
                  htmlFor="New"
                >
                  New
                </label>
            ...
            <div className="w-[280px] h-[48px] rounded-[10px] border-[1px] border-[#E4E4EB] flex justify-between items-center py-[14px] px-[16px]">
              <div>
                <input
                  type="search"
                  name=""
                  className="h-[20px] outline-none text-[#28293D] text-[14px] leading-[20px] font-[500]"
                  id=""
                />
              </div>
              <div>
          ...
          <div className="mt-[20px] flex flex-col gap-[15px]">
            <div className="w-full flex justify-between items-center">
              ...
              <h1 className="text-[#28293D] text-[16px] font-[600] leading-[24px]">
                {miles} miles
              </h1>
            </div>
            ...
            <div className="w-full flex justify-between items-center">
              <div>
                <p className="font-[500] text-[#28293D] text-[12px] leading-[16px]">
                  20 miles
                </p>
              </div>
              <div>
          ...
          <div className="flex max-h-[10000px]  mt-[16px] flex-col gap-[14px]">
            ...
            <div
              className={`pl-[8px]] flex flex-col max-h-full item-start  ${
                more ? "h-full" : "h-[165px]"
              }  overflow-hidden gap-[16px]`}
            >
              {allData.model &&
                Object.keys(allData.model).map((data, index) => {
                  return (
                    <>
                      <div
                      ...
                      >
                        <input
                          value={data}
                          checked={modelType.includes(data)}
                          onChange={(event) => handleModelTypeCars(event)}
                          className="w-[20px] h-[20px] rounded-[4px] border-[2px] border-[#8F90A6] accent-black "
                          type="checkbox"
                          name="New"
                          id=""
                        ...
                        <label
                          ...
                          htmlFor="New"
                        >
                          {data} ({Object.values(allData.model)[index]})
                        </label>
                      </div>
                    </>
                  );
            ...
            {allData?.model && Object.keys(allData.model).length > 0 ? (
              <div
                className="flex cursor-pointer items-center"
                onClick={() => setMore(!more)}
              >
                <h4 className="font-[500]  text-[#FF8800] text-[14px] leading-[20px]">
                  Show more
                </h4>
                <span className="">
                  <FaAngleDown className="text-[#FF8800]" />
                </span>
              </div>
            ) : (
                  ...
                  return (
                    <>
                      ...
                      >
                        <input
                          value={res}
                          onChange={(event) => handleBodyTypeCars(event)}
                          className="w-[20px] h-[20px] rounded-[4px] border-[2px] border-[#8F90A6] accent-black "
                          type="checkbox"
                          name="New"
                          id=""
                        ...
                        <label
                          ...
                          htmlFor="New"
                        >
                          {res} ({Object.values(allData.bodyType)[index]})
                        </label>
                      </div>
                    </>
                  );
        ...
        <div>
          <AddedFilter
            ...
            data4={extFet}
            data5={others}
            head={"INTERIOR FEATURES"}
            head2={"TECHNOLOGY FEATURES"}
            head3={"SAFETY FEATURES"}
            head4={"EXTERIOR FEATURES"}
            head5={"OTHERS"}
          />
        </div>
        <div>
