        ...
        <div className="">
          <div className="pt-[64px] pb-[36px] w-[100%] gap-[253px] px-[60px] flex justify-between items-center bg-[#28293D]">
            <div className="flex justify-center flex-col gap-[24px]">
              <div>
                <Image src="/autodigg2.png" width={132} height={36} />
              </div>
              <div className="max-w-[424px]">
                <p className="font-[400] text-[14px] text-[#8f90a6] leading-[24px]">
            ...
            <div className="flex flex-col gap-[78px] items-end justify-center">
              <div className="flex gap-[30px]">
                <Image src="/Group 59.png" width={40} height={40} />
                <Image src="/Group 60.png" width={40} height={40} />
                <Image src="/Group 61.png" width={40} height={40} />
              </div>
              <div className="flex justify-center items-center gap-[32px] whitespace-nowrap">
                <a
                  href=""
                  className="font-[500] text-[14px] text-[#ffffff] leading-[24px]"
                >
                  How It Works
                </a>
                <a
          ...
          <div className="py-[24px] px-[60px] bg-[#1C1C28] flex justify-between items-center">
            <div>
              <p className="font-[400] text-[10px] text-[#8f90a6] leading-[12px]">
            ...
            <div className="flex justify-center items-center gap-[32px]">
              <div>
                <a
                  href=""
                  className="font-[600] text-[10px] text-[#FFFFFF] leading-[16px]"
                >
                  Terms Of Services
                </a>
              </div>
