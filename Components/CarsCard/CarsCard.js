...
function CarsCard({ cars }) {
    ...
    return (
        <>
            {
                cars ?
                        <section className=' whitespace-nowrap' onClick={()=>router.push(`/${cars.car_id}`)} >
                            <div className="rightBar rounded-[10px] overflow-hidden shadow-cardShadow bg-white h-[330px] w-[890px] flex flex-col">
                                <div className='flex gap-[24px]'>
                                    <div className='carImage w-[360px] h-[254px]'>
                                        {cars.photos.splice(0, 1).map((img) => {
                                            return <Image
                                                src={img}
                                                width={360}
                                                height={277}
                                    ...
                                    <div className='flex flex-col py-[24px] pr-[24px] gap-[96px]'>
                                        <div className='flex flex-col gap-[4px]'>
                                            <div className=''>
                                                <h1 className='font-[700] text-[20px] text-[#28293D] leading-[32px]'>{cars.year} {cars.make} {cars.model} Super Duty</h1>
                                            </div>
                                            <div className='flex flex-col gap-[4px]'>
                                                <div className='flex gap-[10px] '>
                                                    <p className='font-[400] text-[12px] text-[#8F90A6] leading-[16px]'>{cars.dealership}</p>
                                                    <p className='font-[400] text-[12px] text-[#8F90A6] leading-[16px]'> • {cars.milage} Mileage</p>
                                                    <p className='font-[400] text-[12px] text-[#8F90A6] leading-[16px]'> • {cars.exterior_color}</p>
                                                </div>
                                        ...
                                        <div className='flex gap-[250px]'>
                                            ...
                                            <div>
                                                <button style={{ background: "linear-gradient(147.14deg, #FF8800 6.95%, #E63535 93.05%)" }} className='w-[137px] h-[36px] rounded-[10px] shadow-btnShadow px-[16px] py-[6px] text-[#FFFFFF] flex justify-center items-center gap-[2px] drop-shadow-textShadow' onClick={(event) => { event.stopPropagation(); console.log("Button") }}>Invite Dealer <Image src="/Arrow.png" width={15} height={24} /> </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
